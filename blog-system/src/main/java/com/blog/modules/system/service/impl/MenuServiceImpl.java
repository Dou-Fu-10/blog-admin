...
import com.blog.modules.system.service.mapper.MenuMapper;
import com.blog.modules.system.service.mapper.UserMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    private void updateSubCnt(Long menuId) {
        ...
        int count = Math.toIntExact(lambdaQuery().eq(Menu::getPid, menuId).count());
        Menu menu = new Menu();
